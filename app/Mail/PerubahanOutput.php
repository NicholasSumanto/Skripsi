...
class PerubahanOutput extends Mailable
{
    ...
    {
        return new Envelope(subject: 'Perubahan Link Output Permohonan Publikasi');
    }
    ...
    {
        return new Content(view: 'email.perubahan-output');
    }
