...
class EmailController extends Controller
{
    ...
    public function batalPublikasi($email, $nama, $permohonan, $judulPermohonan, $id_proses_permohonan, $pesanBatal)
    {
        try {
            // Kirim Email
            Mail::to($email)->send(new BatalPublikasi($nama, "Publikasi $permohonan", $judulPermohonan, $id_proses_permohonan, $pesanBatal));
