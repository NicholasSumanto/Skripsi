        ...
        <div class="flex flex-col md:flex-row gap-12 max-w-10xl mx-auto w-full items-stretch">
            ...
            <div class="basis-2/3 bg-white p-8 sm:p-2 flex flex-col justify-center">
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <span class="bg-hijau text-white px-2 py-1 rounded-md mb-2 inline-block">Liputan</span> : Hari Pelaksanaan Kegiatan Publikasi Liputan. <br>
                    <span class="bg-kuning text-white px-2 py-1 rounded-md mb-2 inline-block">Promosi</span> : Hari Pelaksanaan Kegiatan Publikasi Promosi. <br>
                    <span class="bg-ungu text-white px-2 py-1 rounded-md mb-2 inline-block">Liputan & Promosi</span> : Hari Pelaksanaan Kegiatan Publikasi Liputan dan Promosi.
                </p>
                                    ...
                                    if (data.length === 0) {
                                        ...
                                        function renderSection(judul, list) {
                                            ...
                                            list.forEach((item, index) => {
                                                ...
                                                const hariPelaksanaan = item.hariPelaksanaan ?? 'text-green-500'
