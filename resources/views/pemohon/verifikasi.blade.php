...
@section('title', 'Verifikasi Permohonan Publikasi')
            ...
            <div class="flex items-center justify-center py-6 bg-white text-center px-4">
                <div class="max-w-md border-4 border-solid p-4 rounded-lg">
                    ...
                    <p class="text-black text-base">
                        ...
                        <a href="{{ route('pemohon.lacak', ['kode_proses' => $data['id_proses_permohonan']]) }}" class="underline font-medium text-blue-700">Lacak</a>.
                    </p>
                </div>
